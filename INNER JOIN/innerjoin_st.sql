...
--  ====================  Atividades ===============================
-- Atividade 1 - Mostre o nome de cada aluno e o nome da turma em que ele está matriculado.
...
-- Atividade 2 - Liste todas as atividades realizadas, mostrando a descrição da atividade, o nome da turma, o nome da matéria e o nome do instrutor responsável.
...
-- Atividade 3 - Apresente os nomes dos instrutores e as matérias que cada um está habilitado a ministrar.
...
-- Atividade 4 - Exiba a descrição de cada atividade junto com o nome e a especialidade do instrutor responsável.

SELECT 
	atividades.descricao AS atividade,
    instrutores.nome AS instrutor,
    instrutores.especialidade AS instrutor

FROM atividades
INNER JOIN instrutores ON instrutores.id = atividades.instrutor_id;

-- Atividade 5 - Mostre a descrição de cada atividade, a data de inicio da turma e a data de término da turma, e o nome da matéria correspondente

SELECT 
	atividades.descricao AS atividade,
    turmas.data_inicio AS turma,
    turmas.data_fim AS turma,
    materias.nome AS materia
...
-- Atividade 6 - Mostre o nome de cada aluno, nome da turma em que está, a descrição da atividade realizada por essa turma, o nome da materia da atividade e o nome do instrutor
...
FROM atividades
INNER JOIN turmas ON atividades.turma_id = turmas.id
INNER JOIN alunos ON atividades.aluno_id = aluno.id
INNER JOIN materias ON atividades.materia_id = materia.id
INNER JOIN instrutores ON atividades.instrutor_id = instrutor.id;
